...
Faça um bom uso do código, treine, reescreva e treine sua logíca, recomendo até criar um tretis mais otimizavél com base no meu :)
**boldÈ necessário instalar o pygame antes, para isso bastar utilizar o comando "pip install pygame"**bold
...
**bold*Exemplo de jogo inspirado em Tetris**bold*
...
**bold*Origem: Wikipédia, a enciclopédia livre.**bold*
